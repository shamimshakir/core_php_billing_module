    ...
    <div class="card-body">
        ...
        <form class="inlineForm" id="msform" enctype='multipart/form-data'>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-sm" name="user_id" id="user_id" value=""
                                   placeholder="User ID">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-sm" name="password" id="password" value=""
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name='client_status' id='client_status'>
                                <?php
                                $library->createCombo("Client Status", "tbl_status_type", "inv_id", "inv_name", "Order by inv_id", 1);
                                ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name="client_type" id="client_type">
                                <?php
                                $library->createCombo("Package", "tbl_client_type", "id", "name", "Order by id");
                                ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-sm" name="bandwidth" id="bandwidth" value="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name="client_catagory" id="client_catagory">
                                <?php
                                $library->createCombo("Client Type", "tbl_client_catagory", "id", "name", " WHERE id != 3 Order by id", 1);
                                ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name="zone" id="zone">
                                <?php
                                $library->createCombo("Zone", "tbl_zone", "zone_id", "zone_name", "Order by zone_id", 1);
                                ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name="bandwidth_plan" id="bandwidth_plan">
                                <?php
                                $library->createCombo("Client Type", "tbl_bandwidth_plan", "id", "bandwidth_plan", "Order by id", 1);
                                ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name="cable_type" id="cable_type">
                                <?php
                                $library->createCombo("Cable Type", "tbl_cable_type", "id", "cable_type", "Order by id", 1);
                                ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name="router" id="router">
                                <?php
                                $library->createCombo("Router", "tbl_router", "router_id", "router_name", "Order by router_id", 1);
                                ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name="switch" id="switch">
                                <?php
                                $library->createCombo("Router", "tbl_switch", "switch_id", "switch_name", "Order by switch_id", 1);
                                ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-sm" name="ip_number" id="ip_number" value=""
                                   placeholder="01xxxxxxxxx">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-sm" name="mrn" id="mrn" placeholder="Money Receipt">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control datepicker input-sm" name="inst_date"
                                   id="inst_date" placeholder="dd/mm/yy">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
            ...
            <fieldset>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-sm" name="father_husband_name"
                                   id="father_husband_name" placeholder="Father/Husband Name">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name='blood_group' id='blood_group'>
                                <?php $library->createCombo("Blood Group", "tbl_blood_group", "id", "blood_group", "Order by id", ""); ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name='gender' id='gender'>
                                <?php $library->createCombo("Gender", "tbl_gender", "id", "gender", "Order by id", ""); ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name='vat_status' id='vat_status' disabled>
                                <?php
                                $library->createCombo("VAT Status", "tbl_vat_type", "status_id", "status_name", "Order by status_id", 1);
                                ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name='area' id='area'>
                                <?php
                                $library->createCombo("Housing/Area", "tbl_area", "area_id", "area_name", "Order by area_id", "");
                                ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name='thana' id='thana'>
                                <?php
                                $library->createCombo("Thana", "tbl_thana", "thana_id", "thana_name", "Order by thana_id", "");
                                ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name='business_type' id='business_type'>
                                <?php
                                $library->createCombo("Business Type", "tbl_business_type", "bus_id", "bus_name", "Order by bus_id", "");
                                ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name='bill_type' id='bill_type' disabled>
                                <?php
                                $library->createCombo("Bill Type", "tbl_bill_type", "id", "name", "Order by id", 1);
                                ?>
                            </select>
                        </div>
                    </div>
                ...
                <input type="button" name="previous" class="previous action-button-previous  btn btn-primary btn-sm"
                       value="Previous"/>
                <input type="submit" name="addClient" id="addClient" class="btn btn-success btn-sm" value="Confirm"/>
            </fieldset>
        </form>
    </div>
</div>
